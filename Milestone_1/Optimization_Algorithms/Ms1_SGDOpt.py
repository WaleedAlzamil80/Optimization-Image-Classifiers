...
def SGD(loss_func, X_init, loss_val, X_val, eta = 0.01, line_search = False, t = 0, decay_type=None, decay_rate=None):
    """
    ...
    # Calculate the loss value and append it to the list
